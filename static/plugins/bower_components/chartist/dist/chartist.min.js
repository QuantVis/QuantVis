...
!(function (a, b) {
  ...
  return (
    (function (a, b, c) {
      "use strict";
      (c.namespaces = { svg: "http://www.w3.org/2000/svg", xmlns: "http://www.w3.org/2000/xmlns/", xhtml: "http://www.w3.org/1999/xhtml", xlink: "http://www.w3.org/1999/xlink", ct: "http://gionkunz.github.com/chartist-js/ct" }),
        (c.noop = function (a) {
          return a;
        }),
        ...
        (c.createChartRect = function (a, b, d) {
          ...
          return (
            e
              ? ("start" === b.axisX.position ? ((k.y2 = j.top + g), (k.y1 = Math.max(i - j.bottom, k.y2 + 1))) : ((k.y2 = j.top), (k.y1 = Math.max(i - j.bottom - g, k.y2 + 1))), "start" === b.axisY.position ? ((k.x1 = j.left + f), (k.x2 = Math.max(h - j.right, k.x1 + 1))) : ((k.x1 = j.left), (k.x2 = Math.max(h - j.right - f, k.x1 + 1))))
          ...
          return function f(b, g) {
            ...
            if (h.length) {
              ...
              for (var j, k = new c.Svg.Path().move(b[0], b[1], !1, g[0]), l = 0, m = b.length; m - 2 * !j > l; l += 2) {
                ...
                j ? (l ? (m - 4 === l ? (n[3] = { x: +b[0], y: +b[1] }) : m - 2 === l && ((n[2] = { x: +b[0], y: +b[1] }), (n[3] = { x: +b[2], y: +b[3] }))) : (n[0] = { x: +b[m - 2], y: +b[m - 1] })) : m - 4 === l ? (n[3] = n[2]) : l || (n[0] = { x: +b[l], y: +b[l + 1] }),
    ...
    (function (a, b, c) {
      ...
      function d(a, b, d) {
        return (
          ...
          b && ((this.options = c.extend({}, d ? this.options : this.defaultOptions, b)), this.initializeTimeoutId || (this.optionsProvider.removeMediaQueryListeners(), (this.optionsProvider = c.optionsProvider(this.options, this.responsiveOptions, this.eventEmitter)))),
    ...
    (function (a, b, c) {
      ...
      (c.Svg = c.Class.extend({ constructor: d, attr: e, elem: f, parent: g, root: h, querySelector: i, querySelectorAll: j, getNode: k, foreignObject: l, text: m, empty: n, remove: o, replace: p, append: q, classes: r, addClass: s, removeClass: t, removeAllClasses: u, height: v, width: w, animate: x })),
          ...
          function (j, k) {
            ...
            (l = h[k + 1] ? h[k + 1] - j : Math.max(this.axisLength - j, 30)),
              (c.isFalseyButZero(i[k]) && "" !== i[k]) ||
                ("x" === this.units.pos
                  ? ((j = this.chartRect.x1 + j), (m.x = e.axisX.labelOffset.x), "start" === e.axisX.position ? (m.y = this.chartRect.padding.top + e.axisX.labelOffset.y + (d ? 5 : 20)) : (m.y = this.chartRect.y1 + e.axisX.labelOffset.y + (d ? 5 : 20)))
                  : ((j = this.chartRect.y1 - j), (m.y = e.axisY.labelOffset.y - (d ? l : 0)), "start" === e.axisY.position ? (m.x = d ? this.chartRect.padding.left + e.axisY.labelOffset.x : this.chartRect.x1 - 10) : (m.x = this.chartRect.x2 + e.axisY.labelOffset.x + 10)),
                g.showGrid && c.createGrid(j, k, this, this.gridOffset, this.chartRect[this.counterUnits.len](), a, [e.classNames.grid, e.classNames[this.units.dir]], f),
                g.showLabel && c.createLabel(j, l, k, i, this, g.offset, m, b, [e.classNames.label, e.classNames[this.units.dir], "start" === g.position ? e.classNames[g.position] : e.classNames.end], d, f));
          }.bind(this)
        );
      }
    ...
    (function (a, b, c) {
      ...
      function d(a) {
        ...
        (d = void 0 === a.axisX.type ? new c.StepAxis(c.Axis.units.x, b.normalized.series, j, c.extend({}, a.axisX, { ticks: b.normalized.labels, stretch: a.fullWidth })) : a.axisX.type.call(c, c.Axis.units.x, b.normalized.series, j, a.axisX)),
          (e = void 0 === a.axisY.type ? new c.AutoScaleAxis(c.Axis.units.y, b.normalized.series, j, c.extend({}, a.axisY, { high: c.isNumeric(a.high) ? a.high : a.axisY.high, low: c.isNumeric(a.low) ? a.low : a.axisY.low })) : a.axisY.type.call(c, c.Axis.units.y, b.normalized.series, j, a.axisY)),
          ...
          a.showGridBackground && c.createGridBackground(g, j, a.classNames.gridBackground, this.eventEmitter),
              ...
              if (
                (m.showPoint &&
                  o.pathElements.forEach(
                    function (b) {
                      var h = i.elem("line", { x1: b.x, y1: b.y, x2: b.x + 0.01, y2: b.y }, a.classNames.point).attr({ "ct:value": [b.data.value.x, b.data.value.y].filter(c.isNumeric).join(","), "ct:meta": c.serialize(b.data.meta) });
      ...
      var f = {
        axisX: { offset: 30, position: "end", labelOffset: { x: 0, y: 0 }, showLabel: !0, showGrid: !0, labelInterpolationFnc: c.noop, type: void 0 },
        axisY: { offset: 40, position: "start", labelOffset: { x: 0, y: 0 }, showLabel: !0, showGrid: !0, labelInterpolationFnc: c.noop, type: void 0, scaleMinSpace: 20, onlyInteger: !1 },
        width: void 0,
        height: void 0,
        showLine: !0,
        showPoint: !0,
    ...
    (function (a, b, c) {
      ...
      function d(a) {
        ...
        (k = a.distributeSeries && a.stackBars ? b.normalized.labels.slice(0, 1) : b.normalized.labels),
          a.horizontalBars
            ? ((j = m = void 0 === a.axisX.type ? new c.AutoScaleAxis(c.Axis.units.x, b.normalized.series, o, c.extend({}, a.axisX, { highLow: d, referenceValue: 0 })) : a.axisX.type.call(c, c.Axis.units.x, b.normalized.series, o, c.extend({}, a.axisX, { highLow: d, referenceValue: 0 }))),
              (l = n = void 0 === a.axisY.type ? new c.StepAxis(c.Axis.units.y, b.normalized.series, o, { ticks: k }) : a.axisY.type.call(c, c.Axis.units.y, b.normalized.series, o, a.axisY)))
            : ((l = m = void 0 === a.axisX.type ? new c.StepAxis(c.Axis.units.x, b.normalized.series, o, { ticks: k }) : a.axisX.type.call(c, c.Axis.units.x, b.normalized.series, o, a.axisX)),
              (j = n = void 0 === a.axisY.type ? new c.AutoScaleAxis(c.Axis.units.y, b.normalized.series, o, c.extend({}, a.axisY, { highLow: d, referenceValue: 0 })) : a.axisY.type.call(c, c.Axis.units.y, b.normalized.series, o, c.extend({}, a.axisY, { highLow: d, referenceValue: 0 }))));
        ...
        l.createGridAndLabels(e, h, this.supportsForeignObject, a, this.eventEmitter),
          ...
          a.showGridBackground && c.createGridBackground(e, o, a.classNames.gridBackground, this.eventEmitter),
          b.raw.series.forEach(
            function (d, e) {
              var f,
                h,
                i = e - (b.raw.series.length - 1) / 2;
              (f = a.distributeSeries && !a.stackBars ? l.axisLength / b.normalized.series.length / 2 : a.distributeSeries && a.stackBars ? l.axisLength / 2 : l.axisLength / b.normalized.series[e].length / 2),
                (h = g.elem("g")),
                h.attr({ "ct:series-name": d.name, "ct:meta": c.serialize(d.meta) }),
                h.addClass([a.classNames.series, d.className || a.classNames.series + "-" + c.alphaNumerate(e)].join(" ")),
                b.normalized.series[e].forEach(
                  function (g, k) {
                    var r, s, t, u;
                    if (
                      ((u = a.distributeSeries && !a.stackBars ? e : a.distributeSeries && a.stackBars ? 0 : k),
                      (r = a.horizontalBars ? { x: o.x1 + j.projectValue(g && g.x ? g.x : 0, k, b.normalized.series[e]), y: o.y1 - l.projectValue(g && g.y ? g.y : 0, u, b.normalized.series[e]) } : { x: o.x1 + l.projectValue(g && g.x ? g.x : 0, u, b.normalized.series[e]), y: o.y1 - j.projectValue(g && g.y ? g.y : 0, k, b.normalized.series[e]) }),
                      l instanceof c.StepAxis && (l.options.stretch || (r[l.units.pos] += f * (a.horizontalBars ? -1 : 1)), (r[l.units.pos] += a.stackBars || a.distributeSeries ? 0 : i * a.seriesBarDistance * (a.horizontalBars ? -1 : 1))),
                      (t = q[k] || p),
                      ...
                      (v[l.units.pos + "1"] = r[l.units.pos]),
                        ...
                        !a.stackBars || ("accumulate" !== a.stackMode && a.stackMode) ? ((v[l.counterUnits.pos + "1"] = p), (v[l.counterUnits.pos + "2"] = r[l.counterUnits.pos])) : ((v[l.counterUnits.pos + "1"] = t), (v[l.counterUnits.pos + "2"] = q[k])),
      ...
      var f = {
        axisX: { offset: 30, position: "end", labelOffset: { x: 0, y: 0 }, showLabel: !0, showGrid: !0, labelInterpolationFnc: c.noop, scaleMinSpace: 30, onlyInteger: !1 },
        axisY: { offset: 40, position: "start", labelOffset: { x: 0, y: 0 }, showLabel: !0, showGrid: !0, labelInterpolationFnc: c.noop, scaleMinSpace: 20, onlyInteger: !1 },
        width: void 0,
        height: void 0,
        high: void 0,
        low: void 0,
            ...
            function (e, g) {
              if (0 !== j.normalized.series[g] || !a.ignoreEmptyValues) {
                ...
                if (
                  ...
                  this.eventEmitter.emit("draw", { type: "slice", value: j.normalized.series[g], totalDataSum: i, index: g, meta: e.meta, series: e, group: k[g], element: y, path: w.clone(), center: n, radius: f, startAngle: l, endAngle: p }),
                  a.showLabel)
                ) {
                  var z;
